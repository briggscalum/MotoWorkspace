...
echo_and_run cd "/home/calum/MotoWorkspace/src/moto_vision"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/calum/MotoWorkspace/src/moto_vision/setup.py" \
    build --build-base "/home/calum/MotoWorkspace/build/moto_vision" \
    install \
    $DESTDIR_ARG \
