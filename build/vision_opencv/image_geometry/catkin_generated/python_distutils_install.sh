...
echo_and_run cd "/home/calum/MotoWorkspace/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/calum/MotoWorkspace/src/vision_opencv/image_geometry/setup.py" \
    build --build-base "/home/calum/MotoWorkspace/build/vision_opencv/image_geometry" \
    install \
    $DESTDIR_ARG \
