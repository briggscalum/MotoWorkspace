...
echo_and_run cd "/home/calum/MotoWorkspace/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/calum/MotoWorkspace/src/vision_opencv/cv_bridge/setup.py" \
    build --build-base "/home/calum/MotoWorkspace/build/vision_opencv/cv_bridge" \
    install \
    $DESTDIR_ARG \
