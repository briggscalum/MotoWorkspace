...
echo_and_run cd "/home/calum/MotoWorkspace/src/robotiq/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/calum/MotoWorkspace/src/robotiq/robotiq_2f_gripper_control/setup.py" \
    build --build-base "/home/calum/MotoWorkspace/build/robotiq/robotiq_2f_gripper_control" \
    install \
    $DESTDIR_ARG \
