...
echo_and_run cd "/home/calum/MotoWorkspace/src/robotiq/robotiq_s_model_control"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/calum/MotoWorkspace/build/robotiq/robotiq_s_model_control" \
    install \
    $DESTDIR_ARG \
