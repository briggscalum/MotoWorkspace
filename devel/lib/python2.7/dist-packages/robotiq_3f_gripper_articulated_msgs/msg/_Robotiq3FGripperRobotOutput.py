...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_18B().pack(_x.rACT, _x.rMOD, _x.rGTO, _x.rATR, _x.rICF, _x.rICS, _x.rPRA, _x.rSPA, _x.rFRA, _x.rPRB, _x.rSPB, _x.rFRB, _x.rPRC, _x.rSPC, _x.rFRC, _x.rPRS, _x.rSPS, _x.rFRS))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.rACT, _x.rMOD, _x.rGTO, _x.rATR, _x.rICF, _x.rICS, _x.rPRA, _x.rSPA, _x.rFRA, _x.rPRB, _x.rSPB, _x.rFRB, _x.rPRC, _x.rSPC, _x.rFRC, _x.rPRS, _x.rSPS, _x.rFRS,) = _get_struct_18B().unpack(str[start:end])
      return self
