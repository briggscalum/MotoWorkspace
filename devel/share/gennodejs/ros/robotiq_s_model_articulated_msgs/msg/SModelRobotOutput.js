...
// (in-package robotiq_s_model_articulated_msgs.msg)
...
class SModelRobotOutput {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SModelRobotOutput(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SModelRobotOutput(null);
...
module.exports = SModelRobotOutput;
